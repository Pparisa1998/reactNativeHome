...
import emptyList from '../images/rolled_eyes.png'
            ...
            <FlatList 
                ...
                renderItem={({item}) => (
                    <Pressable 
                        ...
                        <View>
                            <Text style={styles.itemName}>ชื่อ : {item.name}</Text>
                            <Text style={styles.itemMail}>Email : {item.mail}</Text>
                            <Text style={styles.itemPhone}>เบอร์โทร : {item.phone}</Text>
                        </View>
                    </Pressable>
                )}
            />
